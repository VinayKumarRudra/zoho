...
public interface CreditBankImplementation extends DebitCardImplentation{

	public static void creditCardMethod(Bank bank) {
		...
		while(true) {
			...
			case 4 :
				...
				accountnumber = sc.nextInt();
				float availablebalance = bank.checkBalance(accountnumber);
